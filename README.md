...
- **Release year trends**: How content availability evolved over time  
- **Duration and rating patterns**  
- **Country-wise content distribution**  
- **Visualization insights**: Interactive and static plots to explore trends  
...
## 📝 Key Takeaways
- Netflix has **more movies than TV shows**, but TV shows are growing in recent years.  
...
```bash
git clone https://github.com/YoussefKh117/netflix-analysis.git
